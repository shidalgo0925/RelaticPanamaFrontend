...
export default function LearningDetails() {
  // Datos de la slide de Aprendizaje Continuo
  const slide = {
    id: 1,
    title: "Aprendizaje Continuo",
    subtitle: "Formación y actualización constante",
    description: "Accede a cursos, talleres y recursos para seguir creciendo profesionalmente con expertos latinoamericanos.",
