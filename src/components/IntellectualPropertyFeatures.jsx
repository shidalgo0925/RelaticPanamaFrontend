import { FileText, UserCheck, Map } from 'lucide-react';

export default function IntellectualPropertyFeatures() {
  const features = [
    {
      id: 1,
      icon: FileText,
      title: "Registro Legal",
      description: "Propiedad intelectual protegida oficialmente"
    },
    {
      id: 2,
      icon: UserCheck,
      title: "Asesoría Personalizada",
      description: "Acompañamiento experto en cada proceso"
    },
    {
      id: 3,
      icon: Map,
      title: "Cobertura Regional",
      description: "Protección en toda Latinoamérica"
    }
  ];
