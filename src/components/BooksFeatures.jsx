import { CheckCircle, Hash, Globe } from 'lucide-react';

export default function BooksFeatures() {
  const features = [
    {
      id: 1,
      icon: CheckCircle,
      title: "Publicación Sin Costo",
      description: "Publica gratis sin tarifas ocultas"
    },
    {
      id: 2,
      icon: Hash,
      title: "ISBN y DOI",
      description: "Identificadores académicos disponibles"
    },
    {
      id: 3,
      icon: Globe,
      title: "Distribución Global",
      description: "Alcance mundial para tu obra"
    }
  ];
