...
export default function JournalsFeatures() {
  const features = [
    {
      id: 1,
      icon: CheckCircle,
      title: "Acceso Abierto",
      description: "Revistas científicas disponibles para todos"
    },
    {
      id: 2,
      icon: Star,
      title: "Proceso Transparente",
      description: "Editorial claro y riguroso"
    },
    {
      id: 3,
      icon: Users,
      title: "Difusión Internacional",
      description: "Alcance global para tu investigación"
    }
  ];
